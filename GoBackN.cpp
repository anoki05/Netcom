    ...
    while(i<n){
        ...
        for(int j=i;j<i+m && j<n;j++){
            ...
            if(flag==0 || (flag==1 && b!=0)){
                ...
                cout<<"\nAcknowledgement is not received "<<frames[j]<<"\n";
                check=j;
            }
        }
        if(check!=0){
...
int main()
{
    ...
    cout<<"\nGo Back N protocol";
    cout<<"\n------------------- Possible cases -------------------"<<endl;
    cout<<"1. Frame sent and received within the time limit "<<endl;
    ...
    switch(option){
        case 1:
            cout<<"\nThe situation choosen is frame sent and received the acknowledgement within the time";
            case1(frames,n,m);
            break;
        case 2:
